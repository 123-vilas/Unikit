...
public class DateCounter extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      // assign variables
      btn_birth = findViewById(R.id.st_date);
      btn_today = findViewById(R.id.en_date);
      ...
      btn_birth.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(DateCounter.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, dateSetListener1, year, month, day
            );
      ...
      btn_today.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
            // date picker dialog is used
            // and its style and color are also passed
            DatePickerDialog datePickerDialog = new DatePickerDialog(DateCounter.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, dateSetListener2, year, month, day
            );
            // to set background for datepicker
            datePickerDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            datePickerDialog.show();
         ...
         public void onClick(View view) {
            ...
            try {
               ...
               if (startdate <= endDate) {
                  ...
                  // show message
                  Toast.makeText(DateCounter.this, "BirthDate should not be larger than today's date!", Toast.LENGTH_SHORT).show();
               }
